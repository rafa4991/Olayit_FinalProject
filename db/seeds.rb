...
p7 = Product.create(name: "Avteq Telemedicine Mobile Medical Cart", price: 2987.00, description: "AVTEQ's TMP-800 is an electronically-adjustable tele-medicine flat screen cart with 10RU storage cabinet and heavy-duty casters. It features:
...
Keyboard Tray: 18.5 W x 8 D",
 image: "imersifycart.jpg" , SKU: 1230586)

p8 = Product.create(name: "Telehealth and Mobile Health", price: 89.99, description: "The E-Medicine, E-Health, M-Health, Telemedicine, and Telehealth Handbook provides extensive coverage of modern telecommunication in the medical industry, from sensors on and within the body to electronic medical records and beyond.
...
bridges the gap between scientists, engineers, and medical professionals by creating synergy in the related fields of biomedical engineering, information and communication technology, business, and healthcare.",  image: "telehealthbook.jpg" , SKU: 3032936)
